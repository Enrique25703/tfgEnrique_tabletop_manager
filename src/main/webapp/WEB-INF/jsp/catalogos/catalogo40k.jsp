...
<html lang="es">
  <head>
    ...
    <title>Catálogo Warhammer 40k</title>
        ...
        <main class="page-content">
          <section class="page-panel">
            ...
            <c:if test="${not empty paginaCatalogo.errorCatalogo}">
              <div class="error-box">
                <c:out value="${paginaCatalogo.errorCatalogo}" />. Se muestran los últimos datos cargados si existen.
              </div>
            </c:if>

            <div class="filter-panel">
              <form id="filtroCatalogoForm" class="filter-form" method="get" accept-charset="UTF-8" action="/catalogo40k">
                <div>
            ...
            <c:choose>
              <c:when test="${not empty paginaCatalogo.ejercito}">
                <div class="chip-row">
                  ...
                  <span class="chip" id="recuentoUnidades" role="status" aria-live="polite"><c:out value="${paginaCatalogo.ejercito.totalUnidades}" /> unidades</span>
                </div>
                ...
                <div class="catalog-table-scroll" role="region" aria-label="Unidades del catálogo" tabindex="0"><table class="data-table" id="unidadesCatalogo">
                  ...
                  <tbody>
                    ...
                    <tr id="sinUnidadesFiltradas" hidden><td colspan="1"><div class="catalog-empty"><strong>No hay unidades que coincidan</strong><p>Prueba otro nombre o desactiva alguno de los filtros.</p></div></td></tr>
                  </tbody>
                </table></div>
              </c:when>
              <c:otherwise>
