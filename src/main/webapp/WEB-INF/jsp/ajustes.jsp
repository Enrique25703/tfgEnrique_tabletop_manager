                ...
                <div class="settings-stack">
                  ...
                  <section class="password-card">
                    <div class="password-trigger">
                      <div>
                        <h3 style="margin:0 0 8px;">Cambiar contrasena</h3>
                        <p class="muted-copy">La contrasena solo cambiara si confirmas la actual y repites la nueva dos veces.</p>
                      </div>
                ...
                <div class="modal-card password-modal-card">
                  <div class="modal-header">
                    <div>
                      ...
                      <p class="muted-copy">Indica tu contrasena actual y escribe la nueva dos veces.</p>
                    </div>
      ...
      <div class="modal-card">
        <div class="modal-header">
          <div>
            ...
            <p class="muted-copy">Pulsa una imagen para marcarla con borde azul y confirma la seleccion.</p>
          </div>
          ...
          <c:forEach var="avatar" items="${perfil.avataresDisponibles}">
            <c:if test="${avatar.url ne '/images/default-avatar.svg'}">
              <div
                ...
                data-label="${avatar.etiqueta}"
              >
                <img src="${avatar.url}" alt="<c:out value='${avatar.etiqueta}' />" />
                <span><c:out value="${avatar.etiqueta}" /></span>
              </div>
            </c:if>
          </c:forEach>
        </div>
    ...
    <script>
      (function () {
        ...
        function actualizarPreviewYTexto() {
          ...
          selectionLabel.textContent = "Seleccion actual: " + etiqueta;
        }
