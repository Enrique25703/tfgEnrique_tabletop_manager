            ...
            <div class="admin-grid">
              <section class="admin-section">
                <div class="detail-header">
                  <div>
                    <h3 class="page-title" style="font-size:1.5rem; margin-bottom:6px;">Usuarios</h3>
              ...
              <section class="admin-section">
                <div class="detail-header">
                  <div>
                    <h3 class="page-title" style="font-size:1.5rem; margin-bottom:6px;">Comunidades</h3>
              ...
              <section class="detail-card">
                <c:choose>
                  ...
                  <c:otherwise>
                    <div class="detail-header">
                      <div>
                        <h3 class="page-title" style="font-size:1.4rem; margin-bottom:6px;">
